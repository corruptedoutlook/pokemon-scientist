...
; commands that are used to go to the next set of credits texts.
	...
	db CRED_SPECIAL, CRED_PRET, CRED_TEXT_FADE
	db CRED_GEN_II_GFX, CRED_DANNYE, CRED_TEXT
	db CRED_MON_ICONS, CRED_BLUE_EMERALD, CRED_TEXT
	db CRED_MON_ICONS, CRED_CHAMBER, CRED_TEXT
	db CRED_MON_ICONS, CRED_SOLOO, CRED_TEXT
	db CRED_MON_ICONS, CRED_ET_AL, CRED_TEXT_MON
	db CRED_ROMHACK, CRED_CORRUPTED, CRED_OUTLOOK, CRED_TEXT_FADE_MON
