TypeEffects:
	...
	db POISON,			 PSYCHIC_TYPE, SUPER_EFFECTIVE
	...
	db BUG,          ELECTRIC,     SUPER_EFFECTIVE
	db ROCK,         FIGHTING,     SUPER_EFFECTIVE
	db ROCK,         GROUND,       NOT_VERY_EFFECTIVE
	db ROCK,         FLYING,       SUPER_EFFECTIVE
	db ROCK,         BUG,          SUPER_EFFECTIVE
	db ROCK,         ICE,          SUPER_EFFECTIVE
	db GHOST,        NORMAL,       NOT_VERY_EFFECTIVE
	db GHOST,        PSYCHIC_TYPE, SUPER_EFFECTIVE
	db WATER,				 ICE,					 NOT_VERY_EFFECTIVE
	db FLYING,			 GHOST,				 NOT_VERY_EFFECTIVE
	db GHOST,				 FLYING,			 NOT_VERY_EFFECTIVE
