MoveSoundTable:
	...
	db SFX_BATTLE_26,          $01, $60 ; TOMBSTONER
	db SFX_NOT_VERY_EFFECTIVE, $f0, $e0 ; POSSESSION
	db SFX_BATTLE_1E,          $12, $ff ; SHARP_SCALE
	db SFX_BATTLE_36,          $f0, $20 ; DRACOMETEOR
	db SFX_BATTLE_0F,          $20, $40 ; XSCISSOR
