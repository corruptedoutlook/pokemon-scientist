...
; to said cumulative value, then that slot is chosen.
	...
	wild_chance  8 ;  8/256 =  3.1% chance of slot 8
	wild_chance  8 ;  8/256 =  3.1% chance of slot 9
	wild_chance  6 ;  6/256 =  2.4% chance of slot 10
	wild_chance  6 ;  6/256 =  2.4% chance of slot 11
