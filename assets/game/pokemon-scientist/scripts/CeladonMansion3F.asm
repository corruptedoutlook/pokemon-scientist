...
.Before
	...
	text_end
.AfterText
	text_far _CeladonMansion3FProgrammerAfterRocketText
	text_end
...
.Before
	...
	text_end
.AfterText
	text_far _CeladonMansion3FGraphicArtistAfterRocketText
	text_end
...
.Before
	...
	text_end
.AfterText
	text_far _CeladonMansion3FWriterAfterRocketText
	text_end
...
;	jr nc, .completed_dex
	CheckEvent EVENT_BEAT_CELADON_RADIO_ROCKET
	jr nz, .communications_restored
	ld hl, .Text
	jr .done
;.completed_dex
;	ld hl, .CompletedDexText
.communications_restored
	ld hl, .CommunicationsRestoredText
.done
	call PrintText
	jp TextScriptEnd
.Text:
...
;	jp TextScriptEnd
.CommunicationsRestoredText:
	text_far _CeladonMansion3FGameDesignerCommunicationsRestoredText
	text_end
