...
;	lb bc, BIKE_VOUCHER, 1
	...
	; Pallet Town
	lb bc, FLAG_SET, PALLET_TOWN
	ld hl, wTownVisitedFlag
	predef FlagActionPredef
	; Viridian City
	lb bc, FLAG_SET, VIRIDIAN_CITY
	ld hl, wTownVisitedFlag
	predef FlagActionPredef
	; Pewter City
	lb bc, FLAG_SET, PEWTER_CITY
	ld hl, wTownVisitedFlag
	predef FlagActionPredef
	; Cerulean City
	lb bc, FLAG_SET, CERULEAN_CITY
	ld hl, wTownVisitedFlag
	predef FlagActionPredef
	; Vermilion City
	lb bc, FLAG_SET, VERMILION_CITY
	ld hl, wTownVisitedFlag
	predef FlagActionPredef
	; Lavender Town
	lb bc, FLAG_SET, LAVENDER_TOWN
	ld hl, wTownVisitedFlag
	predef FlagActionPredef
	; Celadon City
	lb bc, FLAG_SET, CELADON_CITY
	ld hl, wTownVisitedFlag
	predef FlagActionPredef
	; Fuchsia City
	lb bc, FLAG_SET, FUCHSIA_CITY
	ld hl, wTownVisitedFlag
	predef FlagActionPredef
	; Cinnabar Island
	lb bc, FLAG_SET, CINNABAR_ISLAND
	ld hl, wTownVisitedFlag
	predef FlagActionPredef
