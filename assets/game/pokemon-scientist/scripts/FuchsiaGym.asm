...
FuchsiaGym_TextPointers:
	...
	dw_const FuchsiaGymKogaRematchPostBattleText, TEXT_FUCHSIAGYM_REMATCH_POST_BATTLE
...
FuchsiaGymRematchDefeatedText:
	...
	text_end
FuchsiaGymKogaRematchPostBattleText:
