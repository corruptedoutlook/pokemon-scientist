...
ViridianGymGiovanniPostBattle:
	...
	set GIOVANNI_REMATCH_BIT, [hl]
	ld a, TEXT_VIRIDIANGYM_REMATCH_POST_BATTLE
	ldh [hTextID], a
	call DisplayTextID
	jp ViridianGymResetScripts
.FirstVictory
	jp ViridianGymReceiveTM27
...
ViridianGym_TextPointers:
	...
	dw_const ViridianGymGiovanniRematchPostBattleText, TEXT_VIRIDIANGYM_REMATCH_POST_BATTLE
...
ViridianGymRematchDefeatedText:
	...
	text_end
ViridianGymGiovanniRematchPostBattleText:
