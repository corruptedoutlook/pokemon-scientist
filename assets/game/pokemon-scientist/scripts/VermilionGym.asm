...
VermilionGymLTSurgeAfterBattleScript:
	...
	jr nz, .Rematch
		; First victory
	jp VermilionGymLTSurgeReceiveTM24Script
.Rematch
	ld hl, wGymLeaderRematchFlags
	set SURGE_REMATCH_BIT, [hl]
...
.before_beat
	...
	set BIT_TALKED_TO_TRAINER,[hl]
	set BIT_PRINT_END_BATTLE_TEXT,[hl]
	ld hl, VermilionGymLTSurgeEndBattleText
	ld de, VermilionGymLTSurgeEndBattleText
	call SaveEndBattleTextPointers
	ld a,$3
	ld [wGymLeaderNo],a
	jr .startBattle
...
VermilionGymLTSurgeTM24NoRoomText:
	...
	text_end
VermilionGymLTSurgeEndBattleText:
	text_far _VermilionGymLTSurgeEndBattleText
	text_end
