...
.NuggetText
	...
	script_mart GREAT_BALL, SUPER_POTION, REVIVE, ESCAPE_ROPE, SUPER_REPEL, ANTIDOTE, BURN_HEAL, ICE_HEAL, AWAKENING, PARLYZ_HEAL, ETHER, FRESH_WATER, SODA_POP, LEMONADE, POKE_DOLL
