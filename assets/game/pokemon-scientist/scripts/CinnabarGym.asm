...
CinnabarGymBlaineBattleScript:
	...
	ld [wCurMapScript], a
	jp TextScriptEnd
CinnabarGymBlaineRematchBattleScript:
	ld hl, wStatusFlags3
	set BIT_TALKED_TO_TRAINER, [hl]
	set BIT_PRINT_END_BATTLE_TEXT, [hl]
	ldh a, [hSpriteIndex]
...
.beforeBeat
	...
	ld a, $7
	ld [wGymLeaderNo], a
	jp CinnabarGymBlaineBattleScript
.BlaineRematch
	...
	ld a, $7
	ld [wGymLeaderNo], a
	jp CinnabarGymBlaineRematchBattleScript
.refused
