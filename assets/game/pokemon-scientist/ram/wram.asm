...
; if $ff, the player's coordinates are not updated when entering the map
	...
	; daycare breeding state
	; 0-1023 = breeding in progress
	; 1024   = child ready
	wDayCareBreedSteps:: dw
	; species of the child that will be produced
	; NO_MON = no pending child
	wDayCareBabySpecies:: db
	; 23 bytes left to use
	wGymLeaderRematchFlags:: db
	wMewRoamingMap:: db
	wMewRoamingLevel:: db
	wMewRoamingHP:: dw
	wMewRoamingEncounter:: db
	ENDU
	;;;;;;;;;
