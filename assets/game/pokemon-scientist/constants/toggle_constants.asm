...
;	const TOGGLE_GYM_GUY                       ; 04
	...
	const TOGGLE_CELADON_ROOF_ROCKET					 ; 46
	toggle_consts_for GAME_CORNER
	const TOGGLE_GAME_CORNER_ROCKET            ; add 1 to subsequent hex
	...
	const TOGGLE_SILPH_CO_7F_UNUSED           ; AA replaced nonexistent sprite
