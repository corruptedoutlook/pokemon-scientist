...
; Pallet Town events
	...
	const EVENT_GAVE_PALLET_GIRL_POKEDOLL
...
; Viridian City events
	...
	const EVENT_USED_OAKS_PARCEL
	const EVENT_LEFT_VIRIDIAN_MART
	const EVENT_STOLE_OAKS_PARCEL
	const_skip 19
...
; Pewter City events
	...
	const EVENT_GOT_ROUTE3_SQUIRTLE
	const_skip 2
...
; Celadon City events
	...
	const_skip
	const EVENT_BEAT_CELADON_RADIO_ROCKET
	const_skip 5
	const EVENT_1B8 ; ???
...
; Seafoam Islands events
	...
	const EVENT_MEW_TRUCK_PENDING
	const EVENT_MEW_TRUCK_USED
	const_skip 6
	const EVENT_BEAT_ARTICUNO
; Post Game events
	const_next $9E0
	const EVENT_PLAYER_IS_CHAMPION
; Vermilion Dock Mew event
	const EVENT_FIGHT_VERMILION_DOCK_MEW
	const EVENT_BEAT_VERMILION_DOCK_MEW
	const EVENT_MEW_ROAMING
; End of events
	const_next $A00
