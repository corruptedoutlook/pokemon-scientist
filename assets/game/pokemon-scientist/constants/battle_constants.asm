...
; wPlayerBattleStatus3 or wEnemyBattleStatus3 bit flags
	...
	const TRANSFORMED         ; 3
	; wGymLeaderRematchFlags bit flags
	const_def
	const BROCK_REMATCH_BIT
	const MISTY_REMATCH_BIT
	const SURGE_REMATCH_BIT
	const ERIKA_REMATCH_BIT
	const KOGA_REMATCH_BIT
	const SABRINA_REMATCH_BIT
	const BLAINE_REMATCH_BIT
	const GIOVANNI_REMATCH_BIT
