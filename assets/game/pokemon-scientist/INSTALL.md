...
If you have different projects that require different versions of `rgbds`, it might not be convenient to install rgbds 1.0.1 globally. Instead, you can put its files in a directory within pokered-gen-2-gfx, such as `pokered-gen-2-gfx/rgbds-1.0.1/`. Then specify it when you run `make`:
