LoadShootingStarGraphics:
	...
	call CopyVideoData
	; Poké Ball at $A3-$A4.
	ld de, GameFreakPokeball
	ld hl, vChars1 tile $7e
	lb bc, BANK(GameFreakPokeball), 2
	call CopyVideoData
...
GameFreakShootingStarOAMData:
	dbsprite 20, 0, 0, 0, $fe, OAM_PAL1
	dbsprite 21, 0, 0, 0, $fe, OAM_PAL1 | OAM_XFLIP
	dbsprite 20, 1, 0, 0, $ff, OAM_PAL1
	dbsprite 21, 1, 0, 0, $ff, OAM_PAL1 | OAM_XFLIP
